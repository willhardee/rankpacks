...
export type Database = {
  public: {
    Tables: {
      ...
      packs: { Row: { id: string; owner_id: string; title: string; category: string; visibility: string; status: string; created_at: string; location: string | null; scheduled_for: string | null } };
